 ...
 * @author Mario
 * 
 * Zrno koje ima dvije funckije.
 * Prilikom učitavanja stranice daje korisniku postojeće podatke iz BP.
 * Kada korisnik pritisne spremi promjene sprema ažurirane podatke u BP.
 */
@ManagedBean
@RequestScoped
public class NadopunaPodataka {
    ...
    /**
     * Prije prikaza stranice korisniku popuni polja s vrijednostima njegovih
     * podataka iz BP.
     */
    @PostConstruct
    public void init() {
    ...
    /**
     * Metoda koja zahtjeva od korisnika da unese ime, prezime i email adresu.
     * Ako korisnik ne unese iste ne dopušta mu se ažuriranje podataka.
     * @return 
     */
