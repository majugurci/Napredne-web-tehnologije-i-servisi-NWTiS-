 ...
 * @author Mario
 * 
 * Klasa koja služi za evidenciju prijavljenog korisnika.
 */
public class Korisnik {
    ...
    public Korisnik(int idKorisnika, int grupa, String grupaOpis, String korisnickoIme, String lozinka, String email, Date vrijemeRegistracije) {
