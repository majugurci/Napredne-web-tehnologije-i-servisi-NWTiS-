 ...
 * @author Mario
 * 
 * Aplikacijski filter koji daje pristup direktoriju /admin samo logiranim
 * korisnicima koji imaju ulogu admin u sustavu.
 */
...
public class AdminFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (hs.getAttribute("korisnik") != null) {
            if (!((Korisnik) (hs.getAttribute("korisnik"))).getGrupaOpis().equals("admin")) {
                String odrediste = "/indexOdabirAkcije.xhtml";
