 ...
 * @author Mario
 * 
 * Obrađuje primljene JMS poruke o adresi. Po primitku poruke šalje zahtjev socket
 * serveru da doda novu adresu.
 */
...
public class AdreseMDB implements MessageListener {
    ...
    /**
     * Pri primitku poruke o adresama šalje zahtjev na socket server. Prvo 
     * šalje komandu da provjeri postoji li adresa u BP aplikacije 1, ako 
     * ne postoji šalje komadnu da ju doda.
     * @param message 
     */
    @Override
    public void onMessage(Message message) {
        try {
            ...
            } else if (odgovorServera.equals("ERR 40;")) {
